...
from workers.queue_parts.state import QueueWorkerStateMixin
from workers.queue_parts.cooldowns import QueueWorkerCooldownMixin

class QueueWorker(QueueWorkerStateMixin, QueueWorkerCooldownMixin, QThread):
